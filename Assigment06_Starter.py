...
# <David Jamieson>,<8/16/20>,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
    ...
    def remove_data_from_list(task, list_of_rows):
        for row in list_of_rows:
                if row["Task"].lower() == task.lower():
                    ...
                    print(task, " has been removed from the table")
                else:
                    print(task, " was not found in table")
        return list_of_rows, 'Success'

    @staticmethod
    def write_data_to_file(file_name, list_of_rows):
        file_name = open("C:\_PythonClass\Assignment06\ToDoList.txt", "w")
        for row in list_of_rows:
            file_name.write(str(row["Task"]) + ',' + str(row["Priority"] + '\n'))
        file_name.close()
...
class IO:
    ...
    def input_new_task_and_priority():
        strTask = str(input("Please enter an Task:"))
    ...
    def input_task_to_remove():
        strTask = str(input("Please enter a task to remove:"))
        return strTask
